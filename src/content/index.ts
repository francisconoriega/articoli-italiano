...
const verbRules: Record<string, ExplanationRule> = {
  verb_modal: {
    title: 'Verbo modal',
    text: 'Los modales **potere** (poder), **volere** (querer) y **dovere** (deber) van seguidos de un **infinitivo**: *devo studiare*, *non posso uscire*.',
  },
  verb_irregular: {
    title: 'Verbo irregular',
    text: 'No sigue el patrón regular: la raíz cambia y hay que **memorizar** las formas (p. ej. *fare → faccio, fai, fa…*).',
  },
  verb_isc: {
    title: 'Verbo en -isc-',
